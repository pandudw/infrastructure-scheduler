...
output "lambda_role_name" {
  ...
  value       = module.ec2_scheduler.lambda_role_name
}

output "ec2_control_policy_arn" {
  description = "The ARN of the EC2 Control IAM Policy"
  value       = aws_iam_policy.ec2_control.arn
}

output "start_schedule_rule_name" {
  description = "The name of the CloudWatch Event rule for starting EC2 instances"
  value       = aws_cloudwatch_event_rule.start_schedule.name
}

output "stop_schedule_rule_name" {
  description = "The name of the CloudWatch Event rule for stopping EC2 instances"
  value       = aws_cloudwatch_event_rule.stop_schedule.name
}

output "start_schedule_rule_arn" {
  description = "The ARN of the CloudWatch Event rule for starting EC2 instances"
  value       = aws_cloudwatch_event_rule.start_schedule.arn
}

output "stop_schedule_rule_arn" {
  description = "The ARN of the CloudWatch Event rule for stopping EC2 instances"
